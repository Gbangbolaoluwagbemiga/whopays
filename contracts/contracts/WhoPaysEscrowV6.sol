...
/**
 * @title WhoPaysEscrowV6_Emergency
 * @dev Production-grade Celo Mainnet Escrow with Arbiter Emergency Override.
 */
contract WhoPaysEscrowV6_Emergency is Ownable {
    ...
    /**
     * @dev EMERGENCY OVERRIDE: Allows Arbiter to resolve a bet even if stuck in Open/Locked.
     */
    function arbiterResolve(bytes32 betId, address winner) external {
